import { Product, ProductVariant } from './admin/product.service';
import { NO_COLOUR } from './admin/light-colours';
...
export { lightColourSwatch, lightColourSwatchRgb, splitLightColourLabel } from './admin/light-colours';
